...
const NewsContainer = () => {
  const newsData2 = [
    {
      id: 1,
      title:
        "Alumnos del IES ALbaytar colaboran para evaluar la eficiencias energética en centros",
    ...
    },
    {
      id: 3,
      title:
        "The Role of AI in Personalized Medicine: Revolutionizing Healthcare",
  ...
  const sortedNews = [...newsData2].sort(
  ...
  const albaytarNews = sortedNews.filter(
    (item) => item.categoria === "ALBAYTAR"
  );
  ...
  return (
    <section className="m-auto h-full w-5/6 py-6 md:py-12 xl:py-16">
      <h1 className="text-center text-5xl font-bold p-4 mb-10">
        NOTICIAS DUALIZA
      </h1>
