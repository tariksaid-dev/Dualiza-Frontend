    ...
    <div className="container grid gap-6 px-4 md:px-6 items-center space-y-0.5">
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <h2 className="text-3xl text-balance text-center font-bold tracking-tighter sm:text-4xl md:text-5xl  text-primary md:text-start">
            Instalaciones de
            <br />
            climatización{"\n"}
          </h2>
          <p className="max-w-[900px] text-foreground md:text-lg/relaxed text-pretty">
        ...
        <div className="relative group overflow-hidden rounded-xl shadow-lg">
          <img
            alt="Image"
            className="object-cover w-full h-auto  hover:transform hover:scale-110 transition-transform duration-1000 ease-in-out group-hover:filter group-hover:brightness-125"
            height="400"
