    ...
    <div className="w-full flex flex-col items-center justify-center h-screen   mb-20 md:mb-0">
      <div className="container grid items-center justify-center gap2 px-4 text-center md:px-6 lg:gap-10">
        ...
        <div className="flex flex-col gap-8 items-center justify-center">
          <p className="text-gray-500 text-pretty md:text-xl/relaxed dark:text-gray-400 ">
            El consumo medio mensual se estima en  <span className='font-semibold text-skin-orange-lanze'>11.123,75 kWh</span>, el coste medio mensual en <span className='font-semibold text-skin-orange-lanze'>1.728,369 €</span>  y la ratio económica del precio de la energía, teniendo en cuenta los datos anteriores, sería de  <span className='font-semibold text-skin-orange-lanze'>0,1553 €/kWh.</span>
          </p>
