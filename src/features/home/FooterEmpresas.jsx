            ...
            <div className=" mx-auto">
                ...
                <div className="flex flex-col items-center mt-10 border-t border-gray-600 pt-6">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <p className="text-sm"><span className='font-bold'>Creators:</span> <a className='hover:underline underline-offset-4 decoration-skin-orange-lanze  ' href="https://github.com/PepeRivera04" target='_blank' rel='noopener noreferrer'>Pepe Rivera</a>, <a className='hover:underline underline-offset-4 decoration-skin-orange-lanze' href="https://github.com/NuMeRo-999" target='_blank' rel='noopener noreferrer'>Pedro Vilchez</a>, <a className='hover:underline underline-offset-4 decoration-skin-orange-lanze' href="https://github.com/tariksaid-dev" target='_blank' rel='noopener noreferrer'>Tarik Said</a>, <a className='hover:underline underline-offset-4 decoration-skin-orange-lanze' href="https://github.com/RogerCiv" target='_blank' rel='noopener noreferrer'>Roger Civantos</a></p>
                    </div>
                </div>
            </div>
        </footer>
